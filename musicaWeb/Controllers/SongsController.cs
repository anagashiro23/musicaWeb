...
namespace musicaWeb.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("nombre,autor,letra,link")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("nombre,autor,letra,link")] Song song)
        {
            if (id != song.nombre)
            {
                return NotFound();
